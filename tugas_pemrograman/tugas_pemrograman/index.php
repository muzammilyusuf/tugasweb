        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="#" onclick="document.getElementById('contentFrame').src='home_content.html'; this.parentNode.parentNode.querySelectorAll('.nav-link').forEach(link => link.style.color = ''); this.style.color = 'blue';">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#" onclick="document.getElementById('contentFrame').src='features_content.html'; this.parentNode.parentNode.querySelectorAll('.nav-link').forEach(link => link.style.color = ''); this.style.color = 'blue';">Features</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#" onclick="document.getElementById('contentFrame').src='pricing_content.html'; this.parentNode.parentNode.querySelectorAll('.nav-link').forEach(link => link.style.color = ''); this.style.color = 'blue';">Pricing</a>
                    </li>
                </ul>
            </div>
        </div>
